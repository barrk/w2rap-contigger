...
void Simplify(const String &fin_dir, HyperBasevector &hb, vec<int> &inv,
              ...
              const Bool FINAL_TINY, const Bool UNWIND3, const bool RUN_PATHFINDER, const bool dump_pf_files, HyperKmerPath& lmp_paths) {// passing by reference, which i need to eventually, doesn't like NULL default
...
//        PathFinder(hb, inv, paths, invPaths, lmp_paths).untangle_complex_in_out_choices(700);
